				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
                            ...
                            <form class="form-auth-small" action="/postlogin" method="POST">
								...
								<button name="buttonlogin" type="submit" class="btn btn-primary btn-lg btn-block">LOGIN</button>
								<div class="bottom">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">E-Campus | Institut Teknologi Budi Utomo</h1>
							<p>by Nugroho Indra Gunawan</p>
						</div>
					</div>
